...
# Built-in React Hooks [Link for this heading](https://react.dev/reference/react/hooks\#undefined "Link for this heading")
...
## State Hooks [Link for State Hooks ](https://react.dev/reference/react/hooks\#state-hooks "Link for State Hooks ")
...
## Context Hooks [Link for Context Hooks ](https://react.dev/reference/react/hooks\#context-hooks "Link for Context Hooks ")
...
## Ref Hooks [Link for Ref Hooks ](https://react.dev/reference/react/hooks\#ref-hooks "Link for Ref Hooks ")
...
## Effect Hooks [Link for Effect Hooks ](https://react.dev/reference/react/hooks\#effect-hooks "Link for Effect Hooks ")
...
## Performance Hooks [Link for Performance Hooks ](https://react.dev/reference/react/hooks\#performance-hooks "Link for Performance Hooks ")
...
## Other Hooks [Link for Other Hooks ](https://react.dev/reference/react/hooks\#other-hooks "Link for Other Hooks ")
...
## Your own Hooks [Link for Your own Hooks ](https://react.dev/reference/react/hooks\#your-own-hooks "Link for Your own Hooks ")
