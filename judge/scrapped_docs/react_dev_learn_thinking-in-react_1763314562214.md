...
# Thinking in React [Link for this heading](https://react.dev/learn/thinking-in-react\#undefined "Link for this heading")
...
## Start with the mockup [Link for Start with the mockup ](https://react.dev/learn/thinking-in-react\#start-with-the-mockup "Link for Start with the mockup ")
...
## Step 1: Break the UI into a component hierarchy [Link for Step 1: Break the UI into a component hierarchy ](https://react.dev/learn/thinking-in-react\#step-1-break-the-ui-into-a-component-hierarchy "Link for Step 1: Break the UI into a component hierarchy ")
...
## Step 2: Build a static version in React [Link for Step 2: Build a static version in React ](https://react.dev/learn/thinking-in-react\#step-2-build-a-static-version-in-react "Link for Step 2: Build a static version in React ")
...
functionProductCategoryRow({category}){
...
functionProductRow({product}){

constname = product.stocked ? product.name :
...
functionProductTable({products}){

constrows = \[\];

letlastCategory = null;
...
return<FilterableProductTableproducts={PRODUCTS}/>;
...
## Step 3: Find the minimal but complete representation of UI state [Link for Step 3: Find the minimal but complete representation of UI state ](https://react.dev/learn/thinking-in-react\#step-3-find-the-minimal-but-complete-representation-of-ui-state "Link for Step 3: Find the minimal but complete representation of UI state ")
...
#### Props vs State [Link for Props vs State ](https://react.dev/learn/thinking-in-react\#props-vs-state "Link for Props vs State ")
...
## Step 4: Identify where your state should live [Link for Step 4: Identify where your state should live ](https://react.dev/learn/thinking-in-react\#step-4-identify-where-your-state-should-live "Link for Step 4: Identify where your state should live ")
...
functionProductTable({products,filterText,inStockOnly}){
...
## Step 5: Add inverse data flow [Link for Step 5: Add inverse data flow ](https://react.dev/learn/thinking-in-react\#step-5-add-inverse-data-flow "Link for Step 5: Add inverse data flow ")
...
## Where to go from here [Link for Where to go from here ](https://react.dev/learn/thinking-in-react\#where-to-go-from-here "Link for Where to go from here ")
