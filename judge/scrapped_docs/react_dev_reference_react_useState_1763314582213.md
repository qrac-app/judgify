...
# useState [Link for this heading](https://react.dev/reference/react/useState\#undefined "Link for this heading")
...
## Reference [Link for Reference ](https://react.dev/reference/react/useState\#reference "Link for Reference ")

### `useState(initialState)` [Link for this heading](https://react.dev/reference/react/useState\#usestate "Link for this heading")
...
#### Parameters [Link for Parameters ](https://react.dev/reference/react/useState\#parameters "Link for Parameters ")
...
#### Returns [Link for Returns ](https://react.dev/reference/react/useState\#returns "Link for Returns ")
...
#### Caveats [Link for Caveats ](https://react.dev/reference/react/useState\#caveats "Link for Caveats ")
...
### `set` functions, like `setSomething(nextState)` [Link for this heading](https://react.dev/reference/react/useState\#setstate "Link for this heading")
...
#### Parameters [Link for Parameters ](https://react.dev/reference/react/useState\#setstate-parameters "Link for Parameters ")
...
#### Returns [Link for Returns ](https://react.dev/reference/react/useState\#setstate-returns "Link for Returns ")

`set` functions do not have a return value.

#### Caveats [Link for Caveats ](https://react.dev/reference/react/useState\#setstate-caveats "Link for Caveats ")
...
## Usage [Link for Usage ](https://react.dev/reference/react/useState\#usage "Link for Usage ")

### Adding state to a component [Link for Adding state to a component ](https://react.dev/reference/react/useState\#adding-state-to-a-component "Link for Adding state to a component ")
...
#### Basic useState examples [Link for Basic useState examples](https://react.dev/reference/react/useState\#examples-basic "Link for Basic useState examples")

1. Counter (number) 2. Text field (string) 3. Checkbox (boolean) 4. Form (two variables)

#### Example1 of4:   Counter (number) [Link for this heading](https://react.dev/reference/react/useState\#counter-number "Link for this heading")
...
### Updating state based on the previous state [Link for Updating state based on the previous state ](https://react.dev/reference/react/useState\#updating-state-based-on-the-previous-state "Link for Updating state based on the previous state ")
...
#### Is using an updater always preferred? [Link for Is using an updater always preferred? ](https://react.dev/reference/react/useState\#is-using-an-updater-always-preferred "Link for Is using an updater always preferred? ")
...
#### The difference between passing an updater and passing the next state directly [Link for The difference between passing an updater and passing the next state directly](https://react.dev/reference/react/useState\#examples-updater "Link for The difference between passing an updater and passing the next state directly")

1. Passing the updater function 2. Passing the next state directly

#### Example1 of2:   Passing the updater function [Link for this heading](https://react.dev/reference/react/useState\#passing-the-updater-function "Link for this heading")
...
### Updating objects and arrays in state [Link for Updating objects and arrays in state ](https://react.dev/reference/react/useState\#updating-objects-and-arrays-in-state "Link for Updating objects and arrays in state ")
...
#### Examples of objects and arrays in state [Link for Examples of objects and arrays in state](https://react.dev/reference/react/useState\#examples-objects "Link for Examples of objects and arrays in state")

1. Form (object) 2. Form (nested object) 3. List (array) 4. Writing concise update logic with Immer

#### Example1 of4:   Form (object) [Link for this heading](https://react.dev/reference/react/useState\#form-object "Link for this heading")
...
### Avoiding recreating the initial state [Link for Avoiding recreating the initial state ](https://react.dev/reference/react/useState\#avoiding-recreating-the-initial-state "Link for Avoiding recreating the initial state ")
...
#### The difference between passing an initializer and passing the initial state directly [Link for The difference between passing an initializer and passing the initial state directly](https://react.dev/reference/react/useState\#examples-initializer "Link for The difference between passing an initializer and passing the initial state directly")

1. Passing the initializer function 2. Passing the initial state directly

#### Example1 of2:   Passing the initializer function [Link for this heading](https://react.dev/reference/react/useState\#passing-the-initializer-function "Link for this heading")
...
### Resetting state with a key [Link for Resetting state with a key ](https://react.dev/reference/react/useState\#resetting-state-with-a-key "Link for Resetting state with a key ")
...
### Storing information from previous renders [Link for Storing information from previous renders ](https://react.dev/reference/react/useState\#storing-information-from-previous-renders "Link for Storing information from previous renders ")
...
## Troubleshooting [Link for Troubleshooting ](https://react.dev/reference/react/useState\#troubleshooting "Link for Troubleshooting ")

### I’ve updated the state, but logging gives me the old value [Link for I’ve updated the state, but logging gives me the old value ](https://react.dev/reference/react/useState\#ive-updated-the-state-but-logging-gives-me-the-old-value "Link for I’ve updated the state, but logging gives me the old value ")
...
### I’ve updated the state, but the screen doesn’t update [Link for I’ve updated the state, but the screen doesn’t update ](https://react.dev/reference/react/useState\#ive-updated-the-state-but-the-screen-doesnt-update "Link for I’ve updated the state, but the screen doesn’t update ")
...
### I’m getting an error: “Too many re-renders” [Link for I’m getting an error: “Too many re-renders” ](https://react.dev/reference/react/useState\#im-getting-an-error-too-many-re-renders "Link for I’m getting an error: “Too many re-renders” ")
...
### My initializer or updater function runs twice [Link for My initializer or updater function runs twice ](https://react.dev/reference/react/useState\#my-initializer-or-updater-function-runs-twice "Link for My initializer or updater function runs twice ")
...
### I’m trying to set state to a function, but it gets called instead [Link for I’m trying to set state to a function, but it gets called instead ](https://react.dev/reference/react/useState\#im-trying-to-set-state-to-a-function-but-it-gets-called-instead "Link for I’m trying to set state to a function, but it gets called instead ")
